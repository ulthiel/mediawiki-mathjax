// This is a merge of configuration TeX-AMS-MML_HTMLorMML-full, and extensions MathJax and SimpleMathJax
$.getScript( mw.config.get('wgExtensionAssetsPath') + '/MathJax/modules/MathJax/MathJax.js',
    function () {
        MathJax.Ajax.config.root = mw.config.get('wgExtensionAssetsPath') + '/MathJax/modules/MathJax';
        MathJax.Hub.Config({
            messageStyle: "none",
            showMathMenu: false,
            config: ["MMLorHTML.js"],
            ...
            TeX: {
                ...
                extensions: ["AMSmath.js","AMSsymbols.js","noErrors.js","noUndefined.js"], // xypic.js not supported in MathJax 2.4 or later
                Macros: {
